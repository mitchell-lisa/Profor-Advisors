  ...
  return (
    <main id="top" className="flex-1">
      ...
      {/*
        ...
        the single most recognizable tell of a generated page; every AI-built
        ...
        serif lead-in, ending in a period, the sentence continuing straight out
        of it, hairlines between. The sequence still reads top to bottom, but
